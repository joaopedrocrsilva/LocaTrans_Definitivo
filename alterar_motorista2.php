...
<div class="container lista">
        ...
        <div class="row">
        <div class="col-lg-12">
            <form action="alterar_motorista2.php?codigo=<?php echo $dadosMotorista->codigo; ?>" method="post">
                    <div class="row">
                    ...
                    <div align="center">
                        ...
                        <a class="btn btn-outline-danger" href="menu_motoristas2.php">Cancelar</a>
                    </div>
            </form>
        </div>
    </div>
