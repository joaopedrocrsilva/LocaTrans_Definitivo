...
$listaRastreador = $rastreador->listarTodos();
  ...
  <div class="row">
    <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse">
      <div class="sidebar-sticky pt-3">
        <ul class="nav flex-column">
          ...
          <li class="nav-item">
            <a class="nav-link active" href="menu_rastreador.php">
              <span data-feather="file"></span>
              Menu Rastreador
            </a>
          </li>
    ...
    <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-md-4">
      <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        <h1 class="h2">Menu Rastreador</h1>
      </div>
    </main>
  </div>
</div>
...
<!--            Listar os alunos vindo do banco de dados-->
                <?php if($listaRastreador) :
                     foreach ($listaRastreador as $rastreador) : ?>
                        <tr>
                        <td><?php echo $rastreador->codigo; ?></td>
                        <td><?php echo $rastreador->localizacao; ?></td>
                        <td>
                            <a href="alterar_rastreador.php?codigo=<?php echo $rastreador->codigo; ?>" class="btn btn-outline-success"><img src="imagens/edit.png"></a>
                            <a href="menu_rastreador.php?codigo=<?php echo $rastreador->codigo; ?>" class="btn btn-outline-danger"><img src="imagens/delete.png"></a>
                        </td>
                    </tr>
            <?php endforeach; ?>
            <?php else: ?>
            <tr>
                <td colspan="6">Nenhum Rastreador Cadastrado.</td>
            </tr>
            <?php endif; ?>
            </tbody>
        </table>
