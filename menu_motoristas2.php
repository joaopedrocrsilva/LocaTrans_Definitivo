...
require_once "Motorista2.php";
$motorista = new Motorista2();
...
<!--            Listar os alunos vindo do banco de dados-->
                <?php if($listaMotorista) :
                     foreach ($listaMotorista as $motorista) : ?>
                        ...
                        <td>
                            <a href="alterar_motorista2.php?codigo=<?php echo $motorista->codigo; ?>" class="btn btn-outline-success"><img src="imagens/edit.png"></a>
                            <a href="menu_motoristas2.php?codigo=<?php echo $motorista->codigo; ?>" class="btn btn-outline-danger"><img src="imagens/delete.png"></a>
                        </td>
                    </tr>
            <?php endforeach; ?>
            <?php else: ?>
